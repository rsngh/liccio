...
Last updated: 2026-06-05 (Alpha 25 — production coherence & evidence truth). Tests: 1147 passing, 5 skipped (docker/pgvector/live-codex unavailable) — see `reports/pytest.txt`;
`ruff` + `mypy` clean across 287 source files; see `reports/coverage.txt`. Gate:
