...
Last updated: 2026-06-05 (Alpha 25 — production coherence & evidence truth). Tests: 1178 passing, 5 skipped (docker/pgvector/live-codex unavailable) — see `reports/pytest.txt`;
`ruff` + `mypy` clean across 291 source files; see `reports/coverage.txt`. Gate:
