...
| The primary oracle resists gaming | red-team: overfit patches (special-case the test's inputs) could fool the whole-test-file oracle on only **2/10** bundles | **solid — wide oracles are hard to game** |
